...
using Telegram.Bot;
using TelegramBotAttachedToMVC.TgBot;
using TelegramBotAttachedToMVC.TgBot.Models;
using TelegramBotAttachedToMVC.TgBot.Services;
...
namespace TelegramBotAttachedToMVC
{
    public class Program
    {
        ...
        {
            var client = new TelegramBotClient("TOP SECRET");
